...
return [
    ...
    */
    ...
    'password' => [
        ...
        'symbols' => 'رمز عبور باید شامل یک کاراکتر ویژه باشد. مانند(*&^%$و...)',
        'numbers' => 'باید حداقل یک عدد داشته باشد',
        'uncompromised' => 'لطفا یک رمز عبور دیگر انتخاب کنید. خطای امنیتی',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'company' => 'اسم شرکت',
        'website' => 'نام وب سایت',
        'company_id_no' => 'شماره ثبت شرکت',
        'avatar' => 'آواتار',
        "province_id" => 'استان',
        "city_id" => 'شهر',
        "industry_id" => 'شهرک صنعتی',
        "full_name" => 'نام',
        "invoice_type" => "نوع پیش فاکتور",
        ...
        "size_id" => "سایز",
        "color_id" => "رنگ",
        "route_name" => "مسیر یا route",
        "color_code" => "کد رنگ",
        "check-sizes" => "انتخاب سایز",
        "check-colors" => "انتخاب رنگ",
        "product_id" => "انتخاب محصول",
        "stock_id" => "موجودی، قیمت و تخفیف",
        "new_value" => "مقدار جدید",
        "product " => "محصول",
        "owner_order" => "صاحب سفارش",
        "work_progression" => "پیشرفت کار",
        "date_order_delivery" => "تاریخ تحویل",
        "date_order_customer" => "تاریخ درخواست سفارش",
        "transaction_code" => "کد رهگیری یا شناسه پرداخت",
        "transaction_type" => "نوع پرداخت",
        "sending_method" => "نحوه ارسال",
        "how_to_order" => "نحوه سفارش",
        "size_id_required" => "فیلد سایز الزامی است.",
        "size_id_integer" => "فیلد سایز باید از نوع عددی باشد.",
        "color_id_required" => "فیلد رنگ الزامی است.",
        "color_id_integer" => "فیلد رنگ باید از نوع عددی باشد.",
        "stock_required" => "فیلد موجودی الزامی است.",
        "stock_integer" => "فیلد موجودی باید از نوع عددی باشد.",
        "price_required" => "فیلد قیمت الزامی است.",
        "price_integer" => "فیلد قیمت باید از نوع عددی باشد.",
        "discount_integer" => "فیلد تخفیف باید از نوع عددی باشد.",
        "discount_type" => "نوع تخفیف",
        "product_type" => "نوع محصول",
        "group-a.*.discount" => "تخفیف",
        "lang_id" => "زبان",
        "key" =>  "کلید",
        "value" =>  "مقدار",
        "permissions" => "سطوح دسترسی",
        "toc" => "قوانین و مقررات",
        "verify_code" => "کد امنیتی",
        "course_id" => 'شناسه دوره',
    ],


    "update.success" => "تغیرات مورد نظر با موفقیت بروز شد",
    "check.error.items" => "لطفا موارد زیر را بررسی کنید:"
];
